...
public class Program
{
    ...
    private static Bitmap GenerateSimpleImage(string username)
    {
        //Prepare main image 
    ...
    private static Bitmap GenerateCustomImage(string username)
    {
        //Prepare main image 
        Bitmap mainImage = new Bitmap(60, 60);
        Graphics newGraphics = Graphics.FromImage(mainImage);
        ...
        {
            //create hash
            string nameOfUser = username + czo.ToString();
            string hash = "";
            using (MD5 md5 = MD5.Create())
            {
                hash = GetMd5Hash(md5, nameOfUser);
    ...
    private static Bitmap GenerateNormalImage(string username)
    {
        //Prepare main image 
        Bitmap mainImage = new Bitmap(60, 60);
        Graphics newGraphics = Graphics.FromImage(mainImage);
